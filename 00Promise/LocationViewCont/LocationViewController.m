...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (tableView == self.searchDisplayController.searchResultsTableView) {
        ...
        Sido* sido = [_sidoArr objectAtIndex:indexPath.row];
        UIImage *backImage;
        if (indexPath.row == 0) {
            backImage = [UIImage imageNamed:@"area_bg01.png"];
        }else if(indexPath.row == [tableView numberOfRowsInSection:indexPath.section]-1){
        ...
        cell.partyLabel.text = sido.name;
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (tableView == self.searchDisplayController.searchResultsTableView) {
        ...
        sigungu = [_sidoArr objectAtIndex:indexPath.row];
        FavoriteLocationViewController* favoriteLocationViewCont = [storyboard instantiateViewControllerWithIdentifier:@"favoriteLocationViewController"];
        favoriteLocationViewCont.sidoId = sigungu.ID.integerValue;
        [self.navigationController pushViewController:favoriteLocationViewCont animated:TRUE];
    }
