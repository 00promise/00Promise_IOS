...
#define COCOAPODS_VERSION_MINOR_FSExtendedAlertKit 1
#define COCOAPODS_VERSION_PATCH_FSExtendedAlertKit 0
...
#define COCOAPODS_VERSION_PATCH_VKDAKeyboardControl 2
